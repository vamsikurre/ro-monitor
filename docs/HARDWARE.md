...
| **Ambient Light Sensor** | 7Semi OPT3004 Digital Ambient Light breakout (I2C, Qwiic) | 1 | RWT node `0x02`, `A4`/`A5`, address `0x45`. Faces the sky; drives **Dark Outside** for the building lights via Alexa — `WIRING.md` §9.6, `RS485_PROTOCOL.md` §4.6 |
